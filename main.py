...
def main(args):
    ...
    word2idx,embedding = build_dictionary(train_texts, vocab_size=args.vocab_size, args.lexical, args.syntactic, args.semantic)
    print("word2idx",word2idx)
    logger.info('Dictionary Finished!')

    full_dataset = CustomTextDataset(train_texts, train_labels, embedding if args.lexical else word2idx)
